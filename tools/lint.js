...
if (scriptTags !== 2) fail(`Expected exactly 2 script tags, found ${scriptTags}.`);
if (/onclick=|onchange=|oninput=/.test(html)) fail("Inline event handlers are not allowed.");
if (!html.includes("assets/core.js") || !html.includes("assets/app.js")) fail("HTML must load core.js and app.js.");
